...
class GalleryImage extends StatelessWidget{
  ...
  const GalleryImage ({Key? key, required this.Image_URL, required this.CrossAxisCell_Count, required this.MainAxisCell_Count}): super (key: key);
...
class CastCard extends StatelessWidget{
  ...
  const CastCard ({Key? key, required this.character, required this.name}): super (key: key);
  @override
  Widget build(BuildContext context) {
    return Card(
      elevation: 0,
          ...
          child: Column(
             mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                ...
                Text('$character', style: const TextStyle( fontSize: 12,
